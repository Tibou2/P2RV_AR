...
IL_0285:
		{
			...
			NullCheck(L_107);
			bool L_110;
			L_110 = VirtFuncInvoker1< bool, Type_t * >::Invoke(119 /* System.Boolean System.Type::Equals(System.Type) */, L_107, L_109);
			if (!L_110)
			{
				goto IL_02f3;
			}
...
IL_02f3:
		{
			...
			NullCheck(L_121);
			bool L_124;
			L_124 = VirtFuncInvoker1< bool, Type_t * >::Invoke(119 /* System.Boolean System.Type::Equals(System.Type) */, L_121, L_123);
			if (!L_124)
			{
				goto IL_0348;
			}
...
IL_0348:
		{
			...
			NullCheck(L_135);
			bool L_138;
			L_138 = VirtFuncInvoker1< bool, Type_t * >::Invoke(119 /* System.Boolean System.Type::Equals(System.Type) */, L_135, L_137);
			if (!L_138)
			{
				goto IL_039d;
			}
...
IL_039d:
		{
			...
			NullCheck(L_149);
			bool L_152;
			L_152 = VirtFuncInvoker1< bool, Type_t * >::Invoke(119 /* System.Boolean System.Type::Equals(System.Type) */, L_149, L_151);
			if (!L_152)
			{
				goto IL_03f2;
			}
...
IL_03f2:
		{
			...
			NullCheck(L_163);
			bool L_166;
			L_166 = VirtFuncInvoker1< bool, Type_t * >::Invoke(119 /* System.Boolean System.Type::Equals(System.Type) */, L_163, L_165);
			if (!L_166)
			{
				goto IL_0447;
			}
...
IL_0447:
		{
			...
			NullCheck(L_177);
			bool L_180;
			L_180 = VirtFuncInvoker1< bool, Type_t * >::Invoke(119 /* System.Boolean System.Type::Equals(System.Type) */, L_177, L_179);
			if (!L_180)
			{
				goto IL_0499;
			}
...
IL_0499:
		{
			...
			NullCheck(L_191);
			bool L_194;
			L_194 = VirtFuncInvoker1< bool, Type_t * >::Invoke(119 /* System.Boolean System.Type::Equals(System.Type) */, L_191, L_193);
			if (!L_194)
			{
				goto IL_04e8;
			}
